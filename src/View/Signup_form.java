...
public class Signup_form extends JFrame implements ActionListener{
    ...
    Signup_form(){
        ...
        l1.setFont(new Font("Monospaced", Font.BOLD, 38));
        
        l2 = new JLabel("Details of yourself");
        l2.setFont(new Font("Monospaced", Font.BOLD, 22));
        ...
        l13 = new JLabel("Date");
        l13.setFont(new Font("Monospaced", Font.BOLD, 14));
        
        l14 = new JLabel("Month");
        l14.setFont(new Font("Monospaced", Font.BOLD, 14));
        
        l15 = new JLabel("Year");
        l15.setFont(new Font("Monospaced", Font.BOLD, 14));
        ...
        t7 = new JTextField();
        t7.setFont(new Font("Monospaced", Font.BOLD, 14));
        ...
        r3.setFont(new Font("Monospaced", Font.BOLD, 14));
        r3.setBackground(Color.WHITE);
        
        r4 = new JRadioButton("Unmarried");
        r4.setFont(new Font("Monospaced", Font.BOLD, 14));
        r4.setBackground(Color.WHITE);
        
        r5 = new JRadioButton("Other");
        r5.setFont(new Font("Monospaced", Font.BOLD, 14));
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
            ...
            if(t6.getText().equals("")){
                ...
                new Singup_form2(first).setVisible(true);
                setVisible(false);
            }
