...
public class Singup_form2 extends JFrame implements ActionListener{
    ...
    Singup_form2(String formno){
        ...
        l7 = new JLabel("NID CARD No: ");
        l7.setFont(new Font("Raleway", Font.BOLD, 18));
        
        l8 = new JLabel("Passport (if any) :");
        ...
        String religion[] = {"Muslim","Hindu","Budhdha","Christian","Other"};
        ...
        String occupation[] = {"Job Holder","Self-Employmed","Business","Student","Retired","Others"};
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
            if(t2.getText().equals("")){
                ...
                String q1 = "insert into signup2 values('"+formno+"','"+religion+"','"+category+"','"+income+"','"+education+"','"+occupation+"','"+nid+"','"+passport+"','"+scitizen+"','"+eaccount+"')";
                c1.s.executeUpdate(q1);
                
                new Signup_form3(formno).setVisible(true);
                setVisible(false);
            }
