...
public class Signup_form3 extends JFrame implements ActionListener{
    ...
    Signup_form3(String formno){
        ...
        l1.setFont(new Font("Impact", Font.BOLD, 22));
        ...
        l5.setFont(new Font("Monospaced", Font.BOLD, 12));
        
        l6 = new JLabel("It would appear on ATM Card/Cheque Book and Statements");
        l6.setFont(new Font("Monospaced", Font.BOLD, 12));
        ...
        l9.setFont(new Font("Monospaced", Font.BOLD, 12));
        ...
        l12.setFont(new Font("Monospaced", Font.BOLD, 14));
        ...
        c7 = new JCheckBox("I Agree with the terms and condition applied ",true);
        c7.setBackground(Color.WHITE);
        c7.setFont(new Font("Monospaced", Font.BOLD, 12));
