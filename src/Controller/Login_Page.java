...
public class Login_Page extends JFrame implements ActionListener{
    ...
    public Login_Page(){
        ...
        l1 = new JLabel("WELCOME TO TRUST BANK");
        ...
        l3.setFont(new Font("Monospaced", Font.BOLD, 28));
        l3.setBounds(100,220,375,30);
        add(l3);
        
        pf2 = new JPasswordField(15);
        pf2.setFont(new Font("Monospaced", Font.BOLD, 14));
